...
[CustomEditor(typeof(GamepadHeadAndBodyController))]
public class XBXInspector : Editor {

    private GamepadHeadAndBodyController instance;

    private bool showOptions = false;

    public override void OnInspectorGUI()
    {
        instance = target as GamepadHeadAndBodyController;
