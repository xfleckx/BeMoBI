...
// original from OWLRigidController
//

public class OWLCustomLRigidController : MonoBehaviour
{
	/// <summary>
    ...
    public bool DisableApplyToTransform = true;
